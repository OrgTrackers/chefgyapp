    ...
    <ImageBackground  style={styles.Signup_Container} source={require('../assets/images/Signup_banner_2.jpg')}>
        ...
        <View style={styles.Signup_Card}>
            ...
            <View style={styles.Signup_Form_Content}>
                <TextInput keyboardType='name-phone-pad' placeholder='Enter full name' style={styles.Signup_Form_Input}></TextInput>
                <TextInput keyboardType='email-address' placeholder='Enter email' style={styles.Signup_Form_Input}></TextInput>
                <TextInput keyboardType='number-pad' placeholder='Enter phone number' style={styles.Signup_Form_Input}></TextInput>
                <TouchableOpacity style={styles.Send_Otp_Btn} onPress={()=>navigation.navigate('OtpContent')}>
