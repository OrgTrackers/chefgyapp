...
import { BookFoodTruckStyles } from './BookFoodTruckScreen.styles';
  ...
  return (
    <View style={GlobalCss.pageLayout}>
      <View style={GlobalCss.HeaderContainer}>
        <TouchableOpacity
          style={BookFoodTruckStyles.HeaderContent}
          onPress={() => navigation.navigate('FoodTruckEventsScreen')}>
          <MCIcons name="chevron-left" size={35} color="#000" />
          <Text style={BookFoodTruckStyles.PageName}>Book Food Truck</Text>
        </TouchableOpacity>
      </View>
      <ScrollView style={GlobalCss.MainContainer} showsVerticalScrollIndicator={false}>
        <View style={BookFoodTruckStyles.BC_Date_Calendar_Container}>
          <View style={BookFoodTruckStyles.BC_Dates_Content}>
            <Text style={[GlobalCss.g_SideHeaders]}>
              When do you want this service ?
            </Text>
            <View style={BookFoodTruckStyles.BC_Date_Inputs}>
              <TouchableOpacity
                onPress={() => {
                  setIsFromDate(true);
                  setShowModal(true);
                }}
                style={[BookFoodTruckStyles.BC_Date_Input, GlobalCss.g_Inputs]}>
                <TextInput
        ...
        <View style={BookFoodTruckStyles.BC_MenuType_Container}>
          <Text style={[GlobalCss.g_SideHeaders]}>Menu Type</Text>
          <View style={BookFoodTruckStyles.Veg_NonVeg_Btns}>
            {/* All Button */}
            <TouchableOpacity
              style={[
                BookFoodTruckStyles.toggleButton,
                menuType.all && BookFoodTruckStyles.toggleButtonActive,
              ]}
              ...
              <Text
                style={
                  menuType.all
                    ? BookFoodTruckStyles.toggleTextActive
                    : BookFoodTruckStyles.toggleText
                }>
                All
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              style={[
                BookFoodTruckStyles.toggleButton,
                menuType.veg && BookFoodTruckStyles.toggleVegButtonActive,
              ]}
            ...
            <TouchableOpacity
              style={[
                BookFoodTruckStyles.toggleButton,
                menuType.nonVeg && BookFoodTruckStyles.toggleNonVegButtonActive,
              ]}
        ...
        <View style={BookFoodTruckStyles.BC_Types_Container}>
          <Text style={[GlobalCss.g_SideHeaders]}>Type of Meals</Text>
          <View style={BookFoodTruckStyles.BC_Type_Cards_Container}>
            {Cater_Type.map(ItemType => (
              <Card
                key={ItemType.Id}
                style={[
                  BookFoodTruckStyles.BC_Type_Cards,
                  selectedTypeId.includes(ItemType.Id) &&
                  BookFoodTruckStyles.selectedCard,
                ]}
                ...
                <Text
                  style={[
                    BookFoodTruckStyles.BC_Type_Name,
                    GlobalCss.ThemeColor.color,
                    selectedTypeId.includes(ItemType.Id) &&
                    BookFoodTruckStyles.selectedText,
                  ]}>
                  {ItemType.name}
                </Text>
              </Card>
        ...
        <View style={BookFoodTruckStyles.BC_Distance_Container}>
          <Text style={[GlobalCss.g_SideHeaders]}>Distance</Text>
          <View style={BookFoodTruckStyles.SliderContainer}>
            <Slider
          ...
          <Text style={BookFoodTruckStyles.Distance_Text}>
            Selected Distance: {minValue} km
          </Text>
        </View>
        <View style={BookFoodTruckStyles.Bc_Rating_Container}>
          <Text style={[GlobalCss.g_SideHeaders]}>Rating</Text>
          <View style={BookFoodTruckStyles.BC_Rating_Stars}>
            {[1, 2, 3, 4, 5].map(star => (
              <TouchableOpacity
                key={star}
                onPress={() =>
        ...
        <View style={BookFoodTruckStyles.BC_Sorting_Container}>
          <Text style={[GlobalCss.g_SideHeaders]}>Sort by </Text>
          <View style={BookFoodTruckStyles.BC_Sorting_Buttons}>
            <TouchableOpacity
              style={[
                BookFoodTruckStyles.Sort_Botton,
                activeSortButton === 'lowToHigh' &&
                BookFoodTruckStyles.Sort_Botton_Active,
              ]}
              onPress={() => setActiveSortButton('lowToHigh')}>
              <Text
                style={[
                  BookFoodTruckStyles.Sort_Botton_Text,
                  activeSortButton === 'lowToHigh' &&
                  BookFoodTruckStyles.Sort_Botton_Active_Text,
                ]}>
                Price: Low To High
              </Text>
            </TouchableOpacity>
      ...
      <Portal>
        <Modal
          ...
          contentContainerStyle={BookFoodTruckStyles.modalContainer}>
      ...
      <View style={GlobalCss.FooterContainer}>
        <View style={BookFoodTruckStyles.FooterButtonContainer}>
          <TouchableOpacity
            style={[
              BookFoodTruckStyles.FooterButton,
              GlobalCss.ThemeBackgroundColor,
            ]}
            onPress={() => navigation.navigate('FoodTruckFoodSessionScreen')}>
            <Text style={BookFoodTruckStyles.FooterButtonText}>
              Apply Filters
            </Text>
          </TouchableOpacity>
        </View>
...
export default BookFoodTruckScreen;
