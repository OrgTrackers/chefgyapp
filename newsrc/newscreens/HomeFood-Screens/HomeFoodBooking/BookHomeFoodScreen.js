...
import { BookHomeFoodStyles } from './BookHomeFoodScreen.styles';
  ...
  return (
    <View style={GlobalCss.pageLayout}>
      ...
      <ScrollView style={GlobalCss.MainContainer} showsVerticalScrollIndicator={false}>
        <View style={BookHomeFoodStyles.BC_Date_Calendar_Container}>
          <View style={BookHomeFoodStyles.BC_Dates_Content}>
            <Text style={[GlobalCss.g_SideHeaders]}>
              When do you want this service ?
            </Text>
            <View style={BookHomeFoodStyles.BC_Date_Inputs}>
              <TouchableOpacity
                onPress={() => {
                  setIsFromDate(true);
                  setShowModal(true);
                }}
                style={[BookHomeFoodStyles.BC_Date_Input, GlobalCss.g_Inputs]}>
                <TextInput
        ...
        <View style={BookHomeFoodStyles.BC_MenuType_Container}>
          <Text style={[GlobalCss.g_SideHeaders]}>Menu Type</Text>
          <View style={BookHomeFoodStyles.Veg_NonVeg_Btns}>
            {/* All Button */}
            <TouchableOpacity
              style={[
                BookHomeFoodStyles.toggleButton,
                menuType.all && BookHomeFoodStyles.toggleButtonActive,
              ]}
              ...
              <Text
                style={
                  menuType.all
                    ? BookHomeFoodStyles.toggleTextActive
                    : BookHomeFoodStyles.toggleText
                }>
                All
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              style={[
                BookHomeFoodStyles.toggleButton,
                menuType.veg && BookHomeFoodStyles.toggleVegButtonActive,
              ]}
            ...
            <TouchableOpacity
              style={[
                BookHomeFoodStyles.toggleButton,
                menuType.nonVeg && BookHomeFoodStyles.toggleNonVegButtonActive,
              ]}
          ...
          <View style={BookHomeFoodStyles.BC_Type_Cards_Container}>
            {Cater_Type.map(ItemType => (
              <Card
                key={ItemType.Id}
                style={[
                  BookHomeFoodStyles.BC_Type_Cards,
                  selectedTypeId.includes(ItemType.Id) &&
                  BookHomeFoodStyles.selectedCard,
                ]}
                ...
                <Text
                  style={[
                    BookHomeFoodStyles.BC_Type_Name,
                    GlobalCss.ThemeColor.color,
                    selectedTypeId.includes(ItemType.Id) &&
                    BookHomeFoodStyles.selectedText,
                  ]}>
                  {ItemType.name}
                </Text>
              </Card>
        ...
        <View style={BookHomeFoodStyles.BC_Distance_Container}>
          ...
          <Text style={BookHomeFoodStyles.Distance_Text}>
            Selected Distance: {minValue} km
          </Text>
        </View>
        <View style={BookHomeFoodStyles.Bc_Rating_Container}>
          <Text style={[GlobalCss.g_SideHeaders]}>Rating</Text>
          <View style={BookHomeFoodStyles.BC_Rating_Stars}>
            {[1, 2, 3, 4, 5].map(star => (
              <TouchableOpacity
                key={star}
                onPress={() =>
        ...
        <View style={BookHomeFoodStyles.BC_Sorting_Container}>
          <Text style={[GlobalCss.g_SideHeaders]}>Sort by </Text>
          <View style={BookHomeFoodStyles.BC_Sorting_Buttons}>
            <TouchableOpacity
              style={[
                BookHomeFoodStyles.Sort_Botton,
                activeSortButton === 'lowToHigh' &&
                BookHomeFoodStyles.Sort_Botton_Active,
              ]}
              onPress={() => setActiveSortButton('lowToHigh')}>
              <Text
                style={[
                  BookHomeFoodStyles.Sort_Botton_Text,
                  activeSortButton === 'lowToHigh' &&
                  BookHomeFoodStyles.Sort_Botton_Active_Text,
                ]}>
                Price: Low To High
              </Text>
            </TouchableOpacity>
      ...
      <Portal>
        <Modal
          ...
          contentContainerStyle={BookHomeFoodStyles.modalContainer}>
      ...
      <View style={GlobalCss.FooterContainer}>
        <View style={BookHomeFoodStyles.FooterButtonContainer}>
          <TouchableOpacity
            style={[
              BookHomeFoodStyles.FooterButton,
              GlobalCss.ThemeBackgroundColor,
            ]}
            onPress={() => navigation.navigate('HomeFoodFoodSessionScreen')}>
            <Text style={BookHomeFoodStyles.FooterButtonText}>
              Apply Filters
            </Text>
          </TouchableOpacity>
        </View>
...
export default BookHomeFoodScreen;
