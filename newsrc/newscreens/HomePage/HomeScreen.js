                ...
                <View style={HomeScreenStyles.HeaderContent}>
                    <TouchableOpacity style={HomeScreenStyles.AddressContainer}>
                        ...
                        <View style={HomeScreenStyles.AddressLine}>
                            <MTIcons name='location-on' size={20} color={GlobalCss.ThemeColor.color}/>
                            <Text style={HomeScreenStyles.AddressText} numberOfLines={1}>5-74,Arunodaya Street,Madhapur,Hyderabad,Telangana</Text>
                        </View>     
                    </TouchableOpacity>
                ...
                <TouchableOpacity style={HomeScreenStyles.UserDetailsCotainer}>
                    ...
                    <View style={HomeScreenStyles.UserRatingContainer}>
                        <View style={HomeScreenStyles.UserRatingTextContainer}>
                            ...
                            <MCIcons name='star' size={12} color={GlobalCss.ThemeColor.color}/>
                        </View>
                        <Text style={HomeScreenStyles.UserRatingTagLine}>Outstanding !</Text>
                    </View>
                </TouchableOpacity>
                <View style={HomeScreenStyles.HomeUpdatesContainer}>
                   <Image source={require('../../newassets/images/Home/HomeMiddle.jpg')} style={HomeScreenStyles.HomeUpdateImage}/> 
                   <TouchableOpacity style={[GlobalCss.ThemeBackgroundColor,HomeScreenStyles.GotoButton]}>
                    ...
                    <View key={HomeCateItem.Id} style={HomeScreenStyles.gridItem}>
                        <Card style={HomeScreenStyles.HomeCateCard}>
                            <View style={HomeScreenStyles.HomeCateImgRatingContainer}>
                                <Image source={HomeCateItem.Image} style={HomeScreenStyles.HomeCateImg}/>
                                <View style={[HomeScreenStyles.HomeCateRatingContainer]}>
                                    <Text style={[HomeScreenStyles.RatingText]}>{HomeCateItem.Rating}</Text>
                                    <MCIcons name='star' size={12} color={GlobalCss.ThemeColor.color}/>
                                </View>
                            </View>
                            <Text style={HomeScreenStyles.HomeCateName}>{HomeCateItem.Name}</Text>
                            <TouchableOpacity style={[GlobalCss.ThemeBackgroundColor,HomeScreenStyles.BookButton]}>
