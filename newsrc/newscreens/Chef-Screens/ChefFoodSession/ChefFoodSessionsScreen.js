...
import { ChefFoodSessionStyles } from './ChefFoodSessions.styles';
  ...
  return (
    <View style={GlobalCss.pageLayout}>
      <View style={GlobalCss.HeaderContainer}>
        <TouchableOpacity
          style={ChefFoodSessionStyles.HeaderContent}
          onPress={() => navigation.navigate('BookChefScreen')}>
          <MCIcons name="chevron-left" size={35} color="#000" />
          <Text style={ChefFoodSessionStyles.PageName}>Chef Food Session</Text>
        </TouchableOpacity>
      </View>
      <ScrollView
        ...
        <View>
          <Image
            ...
            style={ChefFoodSessionStyles.FS_Image}
          />
        </View>
        <View style={ChefFoodSessionStyles.BC_Cater_Allowcation_Container}>
          <Text style={[GlobalCss.g_SideHeaders]}>Cater Allocation</Text>
          {caterAllowcation.map(CA_Item => (
            <View key={CA_Item.Id}>
              <Card style={ChefFoodSessionStyles.BC_Cater_Allowcation_Card}>
                <View
                  style={ChefFoodSessionStyles.BC_Cater_Allowcation_Card_Content}>
                  <View style={ChefFoodSessionStyles.BC_Icon_Allocation_Name}>
                    <MCIcons
                      name={
                    ...
                    <Text
                      style={[
                        ChefFoodSessionStyles.BC_CA_Allocation_Text,
        ...
        <View style={ChefFoodSessionStyles.No_Of_People_Container}>
          <Text style={ChefFoodSessionStyles.Fsa_ValueText}>
            Attendees : {sliderValue[0]} - {sliderValue[1]}
          </Text>
          <View style={ChefFoodSessionStyles.inputWrapper}>
            <Text
              style={[
                ChefFoodSessionStyles.maxMininputLabel,
                GlobalCss.g_appTextBlack,
              ]}>
              Min:{' '}
            </Text>
            <TextInput
              style={[ChefFoodSessionStyles.Rangeinput, GlobalCss.g_Inputs]}
          ...
          <View style={ChefFoodSessionStyles.SliderContainer}>
            <Slider
      ...
      <View style={GlobalCss.FooterContainer}>
        <View style={ChefFoodSessionStyles.FooterButtonContainer}>
          <TouchableOpacity
            style={[
              ChefFoodSessionStyles.FooterButton,
              GlobalCss.ThemeBackgroundColor,
            ]}
            onPress={() => navigation.navigate('ChefSelectionScreen')}>
            <Text style={ChefFoodSessionStyles.FooterButtonText}>Select Chef</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
...
export default ChefFoodSessionScreen;
